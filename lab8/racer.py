...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load(
            r"/Users/kydyrtabyngalyyev/Desktop/lab8/thumbnail.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(
            r"/Users/kydyrtabyngalyyev/Desktop/lab8/coin.png")
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound(
            r'/Users/kydyrtabyngalyyev/Desktop/lab8/crash.wav').play()
        time.sleep(0.5)
